...
public class Customersteps {
	...
	public static ArrayList <Customersteps> mylist =new ArrayList<Customersteps>();
	private Scanner input2;
	

	public void recordinformationinit() {
		mylist.add(new Customersteps(1,"nancy",074561256,"Nablus"));
		mylist.add(new Customersteps(2,"masa",07145654,"Tull-Karem"));
		mylist.add(new Customersteps(3,"Mohammed",07412365,"Hebron"));
		mylist.add(new Customersteps(4,"Dalia",0745021256,"Jerusalem"));
		mylist.add(new Customersteps(5,"Ali",07652256,"Jenin"));
...
public void sendmessage() {
	if(Worker.isIswaiting()==true) {
		System.out.println("The Status of the order: is waiting");
	}
	else if(Worker.isIntretmant()==true) {
		System.out.println("The Status of the order: in treatment");

	}
	else if(Worker.isIscompleted()) {
		System.out.println("The Status of the order: is completed");
